...
// 덕 타이핑 : hp 요소와 Name, Type, Attack, Defense 메서드가 있다면 모두 Pokemon이다.

// Pokemon(인터페이스를 지닌 구조체)를 파라미터로 받는 함수
// 같은 기능을 할 수 있으면, 다른 이름이어도 그 요소도 이 함수를 쓸 수 있도록 다양성을 확보했다.
